            ...
            <View style={styles.content}>
                ...
                <View style={{
                    ...
                    <ImageBackground source={this.state.avatarSource}
                                     style={{width: width, height: 524 / 640 * height}}>
                        <Text style={{
                            position: 'absolute',
                            top: 480 / 640 * height,
                            left: 10,
    ...
    choosePic = () => {
        ImagePicker.showImagePicker(options, (response) => {
            ...
            if (response.didCancel) {
                ...
                let url = 'http://10.112.105.109:9001/upload'; //接口地址
                let file = {...source, type: 'multipart/form-data', name: 'image.png'}; //file中这三个元素缺一不可
